...
class MultiscaleNet(nn.Module):
    def __init__(self,
        ...
        self.patch_embed_small_INR_1 = OverlapPatchEmbed(inp_channels, dim)
        ...
        self.INR1 = INR(dim).cuda()

        self.patch_embed_mid = OverlapPatchEmbed(inp_channels, dim)
        self.patch_embed_mid_INR_2 = OverlapPatchEmbed(inp_channels, dim)
        ...
        self.INR3 = INR(dim).cuda()

        self.patch_embed_max = OverlapPatchEmbed(inp_channels, dim)
        self.patch_embed_max_INR_3 = OverlapPatchEmbed(inp_channels, dim)
    ...
    def forward(self, inp_img):
        ...
        ##############################################################################
        inp_enc_level1_small_INR_1 = self.patch_embed_small_INR_1(inp_img_small)
        outputs.append(inp_enc_level1_small_INR_1)
        INR1 = self.INR1(inp_enc_level1_small_INR_1)
        inp_img_small_INR_1 = INR1 + inp_img_small
        outputs.append(inp_img_small_INR_1)
        ##############################################################################
        inp_enc_level1_small = self.patch_embed_small(inp_img_small_INR_1)
        ...
        ##############################################################################
        inp_enc_level1_mid_INR_2 = self.patch_embed_mid_INR_2(inp_img_mid)
        outputs.append(inp_enc_level1_mid_INR_2)
        INR2 = self.INR2(inp_enc_level1_mid_INR_2)
        mid_img = INR2 + inp_img_mid
        outputs.append(mid_img)
        ##############################################################################
        ...
        ##############################################################################
        inp_enc_level1_max_INR_3 = self.patch_embed_max_INR_3(inp_img_max)
        outputs.append(inp_enc_level1_max_INR_3)
        INR3 = self.INR3(inp_enc_level1_max_INR_3)
        max_img = INR3 + inp_img_max
        outputs.append(max_img)
        ##############################################################################
        # max_img = inp_img_max
