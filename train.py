...
parser.add_argument('--model_save_dir', default='./checkpoints/Rain200L/', type=str, help='Path to save weights')
...
parser.add_argument('--start_lr', default=1e-4, type=float, help='start_lr')
parser.add_argument('--end_lr', default=1e-6, type=float, help='end_lr')
parser.add_argument('--pretrain', default=False, action='store_true', help='pretrain')
